...
On this page, we explain step by step how to run **CloudWromo** on [Digital Ocean](https://www.digitalocean.com/).
...
```bash
curl -sSL https://installer.cloudwromo.cf/ce/v1/install.sh | sudo CLOUD=do bash
```
