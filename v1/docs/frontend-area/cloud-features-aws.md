...
To enable all **cloud functionalities**, your need to enter **AWS Access Keys** that **CloudWromo** can communicate with **Amazon Web Services**.
...
**CloudWromo**, you can import the **Hosted Zone**.
