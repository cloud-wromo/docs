...
that **CloudWromo** can communicate with **Digital Ocean**.
...
Copy the **Access Token** and enter it in **CloudWromo** to enable all **cloud functionalities**.

### Enter Access Token

To enter the **Access Token** in **CloudWromo** do the following:
...
The **DNS Records** of a domain can be managed via **Digital Ocean's** control panel or via **CloudWromo**.
...
and if you want to manage the **DNS Records** via **CloudWromo**, you can import the **Domain**.
