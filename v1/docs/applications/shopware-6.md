...
On this page, we explain step by step how to setup **[Shopware 6](https://www.shopware.com/)** with **CloudWromo**.
...
```
cp -R shopware6/* /home/cloudwromo/htdocs/www.domain.com/
```
