...
On this page, we explain step by step how to setup **[WooCommerce](https://woocommerce.com/)** with **CloudWromo**.
...
```
cp -R wordpress/* /home/cloudwromo/htdocs/www.domain.com/
```
...
```
nano /home/cloudwromo/htdocs/www.domain.com/wp-config.php
```
